...
@section('content')
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
            ...
            <p class="text-sm text-gray-500">Karibu katika paneli ya usimamizi wa Malkia Konnect.</p>
        </div>
        <div class="flex flex-wrap items-center gap-2">
            <button onclick="refreshData()" class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-white text-gray-700 text-sm font-medium border border-gray-200 hover:bg-gray-50">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"></path></svg>
                Refresh
            </button>
            <button onclick="exportToExcel()" class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-emerald-600 text-white text-sm font-medium hover:bg-emerald-700">
    ...
    <div class="mb-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white rounded-xl border border-gray-200 p-4 flex items-center gap-3">
            ...
            <div>
                <p class="text-xs uppercase tracking-wide text-gray-500">Jumla ya Fomu</p>
                <p class="text-xl font-semibold text-gray-900">{{ $stats['total'] ?? 0 }}</p>
            </div>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 p-4 flex items-center gap-3">
            <div class="h-10 w-10 rounded-full bg-yellow-50 flex items-center justify-center">
            ...
            <div>
                <p class="text-xs uppercase tracking-wide text-gray-500">Zinasubiri</p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4 flex items-center gap-3">
            ...
            <div>
                <p class="text-xs uppercase tracking-wide text-gray-500">Zimekamilika</p>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-4 flex items-center gap-3">
            ...
            <div>
                <p class="text-xs uppercase tracking-wide text-gray-500">Watumiaji</p>
                <p class="text-xl font-semibold text-gray-900">{{ $stats['unique_users'] ?? 0 }}</p>
            </div>
        </div>
    </div>
    ...
    @if(session('success'))
        <div class="mb-4 rounded-lg bg-green-50 border border-green-200 text-green-800 px-4 py-3 text-sm flex items-start">
    ...
    @endif
    @if(session('error'))
        <div class="mb-4 rounded-lg bg-red-50 border border-red-200 text-red-800 px-4 py-3 text-sm flex items-start">
    ...
    <div id="form-responses" class="mt-6">
        <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                <p class="text-xs text-gray-500">Jumla ya majibu: {{ $stats['total'] ?? 0 }}</p>
            </div>
