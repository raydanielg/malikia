        ...
        <div class="max-w-2xl w-full text-center space-y-8 sm:space-y-10 fade-in">
            ...
            <div class="pt-8 border-t border-gray-200">
                ...
                <div class="flex justify-center gap-3">
                    <button onclick="shareOnWhatsApp()" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-green-500 text-white hover:bg-green-600 transition-all text-sm font-medium">
